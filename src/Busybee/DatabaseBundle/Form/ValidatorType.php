...
class ValidatorType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('name', 'Symfony\Component\Form\Extension\Core\Type\TextType', array(
					'label'					=> 'validator.label.name',
				)
			)
            ->add('validation', 'textarea', array(
					'label'					=> 'validator.label.validation',
					'help_block'			=> 'validator.help.validation',
				)
			)
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            	'data_class' 			=> 'Busybee\DatabaseBundle\Entity\Validator',
