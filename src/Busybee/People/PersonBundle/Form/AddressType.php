...
use Busybee\People\PersonBundle\Events\AddressSubscriber;
use Busybee\People\PersonBundle\Repository\LocalityRepository;
...
class AddressType extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		$builder
			...
			->add('addressList', AutoCompleteType::class,
				array(
					'class'        => 'Busybee\People\PersonBundle\Entity\Address',
	...
	public function configureOptions(OptionsResolver $resolver)
	{
		$resolver->setDefaults(array(
				'data_class'         => 'Busybee\People\PersonBundle\Entity\Address',
