...
abstract class UserManager implements UserManagerInterface, UserProviderInterface
{
     ...
     * all ACL checks.
     *
     * @deprecated Use Busybee\SecurityBundle\Security\UserProvider instead
     *
    ...
    public function refreshUser(SecurityUserInterface $user)
    {
        ...
        if (!$user instanceof User) {
            throw new UnsupportedUserException(sprintf('Expected an instance of Busybee\SecurityBundle\Model\User, but got "%s".', get_class($user)));
        }
    ...
    /**
     * {@inheritDoc}
     * @deprecated UseBusybee\SecurityBundle\Security\UserProvider instead
     */
