...
final class BusybeeSecurityEvents
{
     ...
     * The event listener method receives a Busybee\SecurityBundle\Event\FilterUserResponseEvent instance.
     */
     ...
     * The event listener method receives a Busybee\SecurityBundle\Event\UserEvent instance.
     */
     ...
     * The event listener method receives a Busybee\SecurityBundle\Event\FormEvent instance.
     */
     ...
     * The event listener method receives a Busybee\SecurityBundle\Event\GetResponseUserEvent instance.
     */
     ...
     *
     * This event allows you to modify the default values of the user before binding the form.
     * The event listener method receives a Busybee\SecurityBundle\Event\GetResponseGroupEvent instance.
     */
     ...
     *
     * This event allows you to access the response which will be sent.
     * The event listener method receives a Busybee\SecurityBundle\Event\FilterGroupResponseEvent instance.
     */
     ...
     *
     * This event allows you to modify the default values of the user before binding the form.
     * The event listener method receives a Busybee\SecurityBundle\Event\GetResponseRoleEvent instance.
     */
